...
DEPENDS = "${@ "glib-2.0 tensorflowlite-prebuilt flatbuffers neuropilot-bin" if d.getVar('MACHINE') == 'i1200-demo' and d.getVar('NDA_BUILD') == '1' else "glib-2.0 tensorflowlite-prebuilt flatbuffers" }"
